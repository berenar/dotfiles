---
name: create-pr
description: Create a GitHub pull request with `gh pr create`, following the repo's existing PR conventions. Use when the user asks to create, open, draft, or push up a PR / pull request.
