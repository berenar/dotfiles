---
name: effort-low
description: Generic worker pinned to LOW reasoning effort. Only use when the dispatching prompt names this agent explicitly or asks for low effort — never auto-select it.
model: inherit
effort: low
color: green
---
