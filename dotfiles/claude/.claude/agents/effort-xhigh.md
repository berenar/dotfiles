---
name: effort-xhigh
description: Generic worker pinned to XHIGH reasoning effort. Only use when the dispatching prompt names this agent explicitly or asks for xhigh effort — never auto-select it.
model: inherit
effort: xhigh
color: red
---
