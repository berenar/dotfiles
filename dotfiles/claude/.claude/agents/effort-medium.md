---
name: effort-medium
description: Generic worker pinned to MEDIUM reasoning effort. Only use when the dispatching prompt names this agent explicitly or asks for medium/mid effort — never auto-select it.
model: inherit
effort: medium
color: yellow
---
